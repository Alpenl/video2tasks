...
def prompt_switch_detection(n_images: int, boundary_recall_only: bool = False) -> str:
    """Backward-compatible alias to the shared prompt definition."""
    return _shared_prompt_switch_detection(n_images, boundary_recall_only=boundary_recall_only)
